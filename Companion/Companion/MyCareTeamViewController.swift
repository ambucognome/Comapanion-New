...
class MyCareTeamViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    let careteamData : [CareTeam] = [
        ...
        CareTeam(image: "2", name: "Aston Merrill", specality: "Dermatology", lastVisitDate: "", experience: "3.06k+", patients: "6 years", review: "2k",bio: "I'm a dermatologist specializing in the treatment of skin diseases and disorders. I'm passionate about helping my patients achieve and maintain healthy skin."),
