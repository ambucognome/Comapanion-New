...
class MessageTableViewCell: UITableViewCell, WKUIDelegate, WKNavigationDelegate {
    ...
    func setUpMessageCell(data: DDCFormModell,entity: Entity, indexPath: IndexPath, tableView: UITableView ) {
...
//            }
        ...
        //uriLbl.text = entity.uri
            self.textView.attributedText = entity.label?.htmlToAttributedString
